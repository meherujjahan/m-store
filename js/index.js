...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
        ...
        <div class="img-div">
            ...
            <div class="d-flex gap-4 mt-1 ms-2">
               <p class="rating">Rating-rate: <span class="rating-point">${product.rating.rate}</span></p>
               <p class="rating">Rating-count: <span class="rating-point">${product.rating.count}</span></p>
            </div>
